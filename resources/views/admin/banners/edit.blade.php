    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.banners.update", [$banner->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('space') ? 'is-invalid' : '' }}" type="text" name="space" id="space" value="{{ old('space', $banner->space) }}" required>
                @if($errors->has('space'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('soucecode') ? 'is-invalid' : '' }}" name="soucecode" id="soucecode">{{ old('soucecode', $banner->soucecode) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('views') ? 'is-invalid' : '' }}" type="number" name="views" id="views" value="{{ old('views', $banner->views) }}" step="1">
                @if($errors->has('views'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clicks') ? 'is-invalid' : '' }}" type="number" name="clicks" id="clicks" value="{{ old('clicks', $banner->clicks) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cpc') ? 'is-invalid' : '' }}" type="number" name="cpc" id="cpc" value="{{ old('cpc', $banner->cpc) }}" step="0.01">
                @if($errors->has('cpc'))
