    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clicks.update", [$click->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uuid') ? 'is-invalid' : '' }}" type="text" name="uuid" id="uuid" value="{{ old('uuid', $click->uuid) }}">
                @if($errors->has('uuid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('landingpage') ? 'is-invalid' : '' }}" type="text" name="landingpage" id="landingpage" value="{{ old('landingpage', $click->landingpage) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_source') ? 'is-invalid' : '' }}" type="text" name="utm_source" id="utm_source" value="{{ old('utm_source', $click->utm_source) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_medium') ? 'is-invalid' : '' }}" type="text" name="utm_medium" id="utm_medium" value="{{ old('utm_medium', $click->utm_medium) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_campaign') ? 'is-invalid' : '' }}" type="text" name="utm_campaign" id="utm_campaign" value="{{ old('utm_campaign', $click->utm_campaign) }}">
