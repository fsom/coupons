    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ads.update", [$ad->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('space') ? 'is-invalid' : '' }}" type="text" name="space" id="space" value="{{ old('space', $ad->space) }}" required>
                @if($errors->has('space'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $ad->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="text" name="value" id="value" value="{{ old('value', $ad->value) }}" required>
                @if($errors->has('value'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('until') ? 'is-invalid' : '' }}" type="text" name="until" id="until" value="{{ old('until', $ad->until) }}" required>
                @if($errors->has('until'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('landingpage') ? 'is-invalid' : '' }}" type="text" name="landingpage" id="landingpage" value="{{ old('landingpage', $ad->landingpage) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('rules') ? 'is-invalid' : '' }}" name="rules" id="rules">{{ old('rules', $ad->rules) }}</textarea>
                @if($errors->has('rules'))
