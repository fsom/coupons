...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="gtin">{{ trans('cruds.product.fields.gtin') }}</label>
                <input class="form-control {{ $errors->has('gtin') ? 'is-invalid' : '' }}" type="text" name="gtin" id="gtin" value="{{ old('gtin', $product->gtin) }}">
                @if($errors->has('gtin'))
                    <span class="text-danger">{{ $errors->first('gtin') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.gtin_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="asin">{{ trans('cruds.product.fields.asin') }}</label>
                <input class="form-control {{ $errors->has('asin') ? 'is-invalid' : '' }}" type="text" name="asin" id="asin" value="{{ old('asin', $product->asin) }}">
                @if($errors->has('asin'))
                    <span class="text-danger">{{ $errors->first('asin') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.asin_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('region') ? 'is-invalid' : '' }}" name="region" id="region">
                    ...
                    @foreach(App\Models\Product::REGION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('region', $product->region) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
