    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.update", [$page->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alias') ? 'is-invalid' : '' }}" type="text" name="alias" id="alias" value="{{ old('alias', $page->alias) }}" required>
                @if($errors->has('alias'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('headline') ? 'is-invalid' : '' }}" type="text" name="headline" id="headline" value="{{ old('headline', $page->headline) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('robots') ? 'is-invalid' : '' }}" name="robots" id="robots">
                    ...
                    @foreach(App\Models\Page::ROBOTS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('robots', $page->robots) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
